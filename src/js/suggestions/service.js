...
angular.module('mean.suggestions').factory('Suggestions', ['$resource', function($resource) {
...
**/
angular.module('mean.suggestions').service('SuggestionsCollection', ['Global', 'Suggestions', function(Global, Suggestions) {
		...
		load: function() { 
		   	...
		   	Suggestions.query(function(suggestions) {      
		     	...
		     	angular.forEach(suggestions, function(suggestion) {
			       	...
			       	SuggestionsCollection.readCount = SuggestionsCollection.all.reduce(function(count, suggestion) { return suggestion.read ? count : count; }, 0);
			       	SuggestionsCollection.starredCount = SuggestionsCollection.all.reduce(function(count, suggestion) { return suggestion.starred ? count : count; }, 0);
