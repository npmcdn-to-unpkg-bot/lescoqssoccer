	...
	function ($scope, Global) {
		...
		var ropeDemo = {
			...
			Initialize: function() {
				...
				ropeDemo.context.img0.src = '../../img/lamp0.png';
				ropeDemo.context.img1.src = '../../img/lamp1.png';
			},
			Light: function() {
				throw "Not implemented";
			},
		...
		ropeDemo.Light = function() {
			...
			$('#cms-sidebar-nav-list li a').removeClass('hidden');
		}
		...
		ropeDemo.noLight = function() {
			...
			$('#cms-sidebar-nav-list li a').addClass('hidden');
		}
