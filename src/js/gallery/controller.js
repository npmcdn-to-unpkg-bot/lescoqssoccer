...
angular.module('mean.albums').controller('PhotoCtrl', ['$scope', '$location', '$modal', 'PhotoMgrService', 'photos', 'photo', 'view',
...
angular.module('mean.albums').controller('AlbumCtrl', ['$location', '$scope', '$modal', 'PhotoMgrService', 'album', 'albums', 'view',
...
PhotoMgrData = { 
    ...
    album: function(AlbumsCollection, $route) {
        return $route.current.params.albumId ? AlbumsCollection.get({id: $route.current.params.albumId}).$promise : new AlbumsCollection();
    },

    photo: function(PhotosCollection, $route) {
        return $route.current.params.photoId ? Photo.get({id: $route.current.params.photoId}).$promise : new PhotosCollection();
    },
...
GalleryData = {
    ...
    photos: function(PhotosCollection, $route) {
        return $route.current.params.albumId ? AlbumsCollection.getPhotos({id: $route.current.params.albumId}).$promise : PhotosCollection.query().$promise;
    }
};

//Pre load entire photo list; TODO: move random selection from HomeCtrl to backend 
HomeData = {
    photos: function(PhotosCollection) {
        return PhotosCollection.query().$promise;
    }
};
