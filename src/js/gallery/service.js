...
angular.module('mean.albums').factory('PhotosCollection', ['$resource', function($resource) {
...
angular.module('mean.albums').factory('AlbumsCollection', ['$resource', function($resource) {
...
angular.module('mean.albums').service('PhotoMgrService', ['Global', 'AlbumsCollection', 'PhotosCollection', function(Global, AlbumsCollection, Photo) {

      var global = Global;
      var pmSvc = {};

      pmSvc.editAlbumPhotos = function (action, photo, album) {
         return AlbumsCollection.editAlbumPhotos({action: action, _id: album._id, photoId: photo._id}, function(data){
            return data;
         });
      }
      
      pmSvc.getAlbum = function (id) {
         return AlbumsCollection.get({id: id}, function(data) {
            return data;
         }).$promise; 
      }    
      ...
      pmSvc.toggleEnabled = function(id) {
         return AlbumsCollection.get({id: id}, function(album) {
      ...
      pmSvc.getAlbumPhotos = function(id) {
         return AlbumsCollection.getPhotos({id: id}, function(data) {
            return data;
         }).$promise;
      }
